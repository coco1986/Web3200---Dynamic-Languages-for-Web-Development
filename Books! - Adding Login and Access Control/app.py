...
class ConfigClass(object):
    ...
    MAIL_USE_SSL = True
    MAIL_USE_TLS = False
    MAIL_USERNAME = 'corycoleman726@gmail.com'
    MAIL_PASSWORD = 'Alison@90'
...
def create_app():
    ...
    def seedDB():
        ...
        sqlQ = db.engine.execute('DROP TABLE IF EXISTS Category',commit=True)

        sqlQuery = db.engine.execute('CREATE TABLE Book (author TEXT,title TEXT, isbn INTEGER, description TEXT, category_id INTEGER)',commit=True)
        sqlQuery = db.engine.execute('CREATE TABLE Category (description TEXT)',commit=True)
        sqlQuery2 = db.engine.execute('INSERT INTO Book (author,title, description) VALUES ("Mary Shelley","Frankenstein", "A horror story written by a romantic.")',commit=True)
        ...
        sqlQuery2 = db.engine.execute('INSERT INTO Book (author,title, description) VALUES ("Max Weber","The Protestant Work Ethic and The Spirit of Capitalism", "A classic early 20th C. sociology text")',commit=True)
        sqlQuery2 = db.engine.execute('INSERT INTO Book (author,title, description) VALUES ("Robert Putnam","Bowling Alone", "A classic late 20th C. sociology text")',commit=True)
